@props(['title', 'description' => 'SI Bimbingan Skripsi - Universitas Halu Oleo', 'csrfToken', 'baseurl'])
...
<meta name="keywords" content="UHO, Universitas Halu Oleo, Fakultas Keguruan dan Ilmu Pendidikan, PTIK, Kendari, Sulawesi Tenggara">
<meta name="author" content="PTIK UHO">

<!-- Open Graph Meta Tags for Social Sharing -->
<meta property="og:title" content="{{ $title }} - SI Bimbingan Skripsi - Universitas Halu Oleo">
...
<meta name="twitter:title" content="{{ $title }} - SI Bimbingan Skripsi - Universitas Halu Oleo">
<meta name="twitter:description" content="{{ $description }}">
<meta name="twitter:site" content="@UHO_Official">
...
<!-- Title -->
<title>{{ $title }} - SI Bimbingan Skripsi UHO</title>
